...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT we declare rando using var in the first time and the var works globaly even if you declare it in side a block,
  // but let doesn't do that it will make a declaretion globaly and another in the block.
  console.log(viewed);
